			...
			selector:
				'<div id="date-selector">' +
					'<div class="select day">' +
						'<span class="btn-arrow btn-up material-symbols-rounded">arrow_drop_up</span>' +
						'<div>' +
							'<span class="num">01</span>' +
							'<span class="text">Thursday</span>' +
						'</div>' +
						'<span class="btn-arrow btn-down material-symbols-rounded">arrow_drop_down</span>' +
					'</div>' +
					...
					'</div>' +
					'<div id="date-overlay">' +
						'<span>Click to enable date modification</span>' +
					'</div>' +
				'</div>'
		},
		defaults: {
